...
public class TowerMarine extends Tower
{
	//Firing delay variable
	private int timeBetweenShots;
	
	public TowerMarine(GameState state, Point position)
	{
	...
	public void update() 
	{
		...
		if ((nearbyEnemy.getLocation().distance(position) ) < 60 && timeBetweenShots > 130)
		{
